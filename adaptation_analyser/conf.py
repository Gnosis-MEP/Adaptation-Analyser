...
LISTEN_EVENT_TYPE_SERVICE_SLR_PROFILES_RANKED = config('LISTEN_EVENT_TYPE_SERVICE_SLR_PROFILES_RANKED')
LISTEN_EVENT_TYPE_SCHEDULING_PLAN_EXECUTED = config('LISTEN_EVENT_TYPE_SCHEDULING_PLAN_EXECUTED')
...
PUB_EVENT_TYPE_NEW_QUERY_SCHEDULING_PLAN_REQUESTED = config('PUB_EVENT_TYPE_NEW_QUERY_SCHEDULING_PLAN_REQUESTED')
PUB_EVENT_TYPE_SERVICE_WORKER_OVERLOADED_PLAN_REQUESTED = config('PUB_EVENT_TYPE_SERVICE_WORKER_OVERLOADED_PLAN_REQUESTED')
PUB_EVENT_TYPE_SERVICE_WORKER_SLR_PROFILE_CHANGE_PLAN_REQUESTED = config('PUB_EVENT_TYPE_SERVICE_WORKER_SLR_PROFILE_CHANGE_PLAN_REQUESTED')
PUB_EVENT_TYPE_SERVICE_WORKER_BEST_IDLE_REQUESTED = config('PUB_EVENT_TYPE_SERVICE_WORKER_BEST_IDLE_REQUESTED')
PUB_EVENT_TYPE_UNNECESSARY_LOAD_SHEDDING_REQUESTED = config('PUB_EVENT_TYPE_UNNECESSARY_LOAD_SHEDDING_REQUESTED')

PUB_EVENT_LIST = [
    PUB_EVENT_TYPE_NEW_QUERY_SCHEDULING_PLAN_REQUESTED,
    ...
    PUB_EVENT_TYPE_UNNECESSARY_LOAD_SHEDDING_REQUESTED,
]
